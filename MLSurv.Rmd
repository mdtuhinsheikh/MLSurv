...
## Getting Started
- The source codes and necessary documentations are available at the repository: ( https://mdtuhinsheikh.github.io/MLSurv/).
...
- What if human can train the machines? @goodfellow2016deep and @lee2018deephit. [@goodfellow2016deep; @lee2018deephit]


## An illustration of Machine Learning
![](./Figures/machineLearningBasics.png){width=850px, height=400px}

## Basic paradigm
![](./Figures/MLbasicParadigm.png){width=950px, height=300px}

## An example of machine learning
![](./Figures/getTheCake1.png){width=850px, height=300px}


## An example of machine learning
![](./Figures/getTheCake2.png){width=850px, height=300px}

## An example of machine learning
![](./Figures/getTheCake3.png){width=850px, height=300px}

## Basics of Deep Learning
- $\color{blue}{\text{Deep Learning}}$ (very similar to human neural system) is a special kind of $\color{blue}{\text{Machine Learning}}$ [@goodfellow2016deep].
- Especially, useful to generalize complicated functions in high dimensional space.
- Synonymous terms: `Deep feed-forward networks', `feed-forward neural networks', or `multi-layer perceptrons' (MLPs). $\color{blue}{\text{lovely blue}}$
...
## Motivating example for deep neural network
...
## Motivating example for deep neural network
![](./Figures/singleLayerNeuralNetwork.png){width=850px, height=300px}


## Motivating example for deep neural network
![](./Figures/twoLayerNeuralNetwork.png){width=850px, height=300px}
...
- Self customizing program: Amazon, Netflix.
...
![](./Figures/healthcare.png){width=550px, height=300px}
...
![](./Figures/education.png){width=550px, height=300px}
...
![](./Figures/crowdfunding.png){width=550px, height=300px}
...
- Survival Tree: is similar to decision tree which is built by recursive splitting of tree nodes. 
  ...
  + Random Survival Forest \citep{ishwaran2008random}
  + $\color{red}{\text{Note:}}$ these algorithms are mostly useful for classification, \underline{however}, cannot predict time-to-event and regression.
...
- Feed-forward non-linear proportional hazards model \citep{faraggi1995neural}.
  + The Cox PH model (with standard notation) is 
  + @faraggi1995neural extends the linear function $\boldsymbol{\beta^T}\mathbf{x}$ to a non-linear `activation function', $g(\mathbf{x}, \boldsymbol{\theta})$
...
![](./Figures/detail3.png){width=550px, height=300px}
